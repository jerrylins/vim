...
behave mswin "set mouse behavior as xterm
"/////////////////////////////////////////////////////////////////////////////
...
function g:ex_CustomHighlight()
    ...
    hi MBENormal  ctermfg=Gray guibg=LightGray guifg=DarkGray
 "   hi MBENormal ctermbg=LightGray ctermfg=DarkGray guibg=LightGray guifg=DarkGray
    " for buffers that HAVE CHANGED and are NOT VISIBLE
    hi MBEChanged ctermfg=DarkRed guibg=Red guifg=DarkRed
    " buffers that have NOT CHANGED and are VISIBLE
    hi MBEVisibleNormal term=bold cterm=bold ctermfg=LightBlue  gui=bold guibg=Gray guifg=Black
   " hi MBEVisibleNormal term=bold cterm=bold ctermbg=Gray ctermfg=Bisque gui=bold guibg=Gray guifg=Black
    " buffers that have CHANGED and are VISIBLE

    hi MBEVisibleChanged term=bold cterm=bold ctermfg=Red gui=bold guibg=DarkRed guifg=Black
